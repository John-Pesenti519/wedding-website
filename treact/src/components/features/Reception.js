    ...
    <Container>
      <TwoColumn css={!imageInsideDiv && tw`md:items-center`}>
        <ImageColumn css={imageContainerCss}>
          {imageInsideDiv ? <Image imageSrc="https://39ta4149r0i63bptauxfvpkt-wpengine.netdna-ssl.com/wp-content/uploads/2019/12/Perona-Farms-Refinery-Loggia-800x450.jpg" css={imageCss} /> : <img src={imageSrc} css={imageCss} alt="" />}
