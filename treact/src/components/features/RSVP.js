    ...
    <Container>
      <TwoColumn css={!imageInsideDiv && tw`md:items-center`}>
        <ImageColumn css={imageContainerCss}>
          {imageInsideDiv ? <Image imageSrc="https://www.rosepaperscissors.com/wp-content/uploads/2018/05/meraki_Wedding-invitation_7_web-1-1024x683.jpg" css={imageCss} /> : <img src={imageSrc} css={imageCss} alt="" />}
