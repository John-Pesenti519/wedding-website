...
export default ({
  ...
  const defaultStatistics = [
    {
      value: <a href="https://www.peronafarms.com/status/">Perona Farms Covid-19 Policy</a>
    }
  ];
    ...
    <Container>
      <TwoColumn css={!imageInsideDiv && tw`md:items-center`}>
        <ImageColumn css={imageContainerCss}>
          {imageInsideDiv ? <Image imageSrc="https://johntestbuck.s3.amazonaws.com/File_001.jpeg" css={imageCss} /> : <img src={imageSrc} css={imageCss} alt="" />}
